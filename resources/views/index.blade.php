...
@section('content')
    ...
    <div class="container-fluid p-0">
        ...
        {{-- Two Image Slider --}}
        @if(isset($twoImageSliders) && $twoImageSliders->count() > 0)
            <div class="mini-slider-container">
                <div class="container mt-5">
                    <div class="row g-4">
                        <div class="col-12 col-md-6">
                            <div id="two-image-slider-0" class="owl-carousel owl-theme">
                                @foreach ($twoImageSliders->filter(function ($item, $index) {
                                    return $index % 2 == 0; }) as $sliderItem)
                                    <div class="item mini-slider-wrapper">
                                        <div class="mini-slider-shadow">
                                            <img src="{{ url('uploads/two-image-slider/' . $sliderItem->image) }}"
                                                alt="{{ $sliderItem->title }}" class="img-fluid mini-slider-image"
                                                style="width: 100vw;">
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        <div class="col-12 col-md-6">
                            <div id="two-image-slider-1" class="owl-carousel owl-theme">
                                @foreach ($twoImageSliders->filter(function ($item, $index) {
                                    return $index % 2 == 1; }) as $sliderItem)
                                    <div class="item mini-slider-wrapper">
                                        <div class="mini-slider-shadow">
                                            <img src="{{ url('uploads/two-image-slider/' . $sliderItem->image) }}"
                                                alt="{{ $sliderItem->title }}" class="img-fluid mini-slider-image"
        ...
        <div class="category-container">
                        ...
                        @foreach ($category as $cat)
                            <div class="category-item text-center">
                                <div class="icon-container">
                                    <a href="{{ route('category.main', ['id' => $cat->id]) }}">
                    ...
                    <div class="categories-slider-ltr-sub owl-carousel owl-theme">
                        @foreach ($subcategories as $cat)
                            <div class="category-item text-center">
                                <div class="icon-container">
                                    <a href="{{ route('category.main', ['id' => $cat->id]) }}">
                                        @if(!empty($cat->image) && file_exists(public_path('uploads/category/' . $cat->image)))
                                            <img src="{{ asset('uploads/category/' . $cat->image) }}" alt="{{ $cat->name }}"
                                                class="category-img mt-4">
                                        @else
            ...
            {{-- Single Slider --}}
            @if(isset($secondSlider) && $secondSlider->count() > 0)
                <div class="single-slider">
                    <div class="owl-carousel owl-theme mt-5">
                        @foreach ($secondSlider as $sliderItem)
                            <div class="item">
                                @if ($sliderItem->image)
                                    <img src="{{ url('/uploads/second-slider/' . $sliderItem->image) }}" alt="Image" class="w-100"
            ...
            <div class="slider-wrap-brand">
                ...
                <div class="slider-rail-brand" id="rail">
                    @foreach ($brandsForSlider as $b)
                        <div class="card-brand">
                            <a href="{{ url('/brand/' . $b->id . '/products') }}">
            ...
            {{-- Authorized Brands
            <div class="authorised-brands">
                <div class="container">
                    <h2 class="text-center mt-4 mb-2 text-dark">Authorized Brands</h2>
                    ...
                    <div class="brands-slider mt-3" id="brandsSlider">
                        <div class="brands-track" id="brandsTrack"> --}}
                            ...
                            @endforeach --}}
                            {{-- Duplicate set for seamless loop when needed --}}
                            {{-- @foreach ($brand as $b)
                            <div class="brand-item duplicate">
                                <div class="icon-container">
                                    <a href="{{ url('/brand') }}">
                                        <img src="{{ asset($b->image) }}" alt="{{ $b->name }}" class="brand-logo">
                                    </a>
                        ...
                        <div class="row g-4">
                            <div class="col-12 col-md-6">
                                <div id="mini-slider-0" class="owl-carousel owl-theme">
                                    @foreach ($minislider->filter(function ($item, $index) {
                                        return $index % 2 == 0; }) as $image)
                                        <div class="item mini-slider-wrapper">
                                            <div class="mini-slider-shadow">
                                                <img src="{{ url('uploads/mini-slider/' . $image->image) }}" alt="Slider Image"
            ...
            {{-- YouTube Videos dynamic section--}}
                                ...
                                <div class="item">
                                    <div class="card" style="width: 100%; height: auto;">
                                        ...
                                        <div class="card-body d-flex align-items-center justify-content-between">
                                            ...
                                            <h5 class="card-title mb-0" style="font-size: 1rem;">{{ $video->title }}</h5>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
