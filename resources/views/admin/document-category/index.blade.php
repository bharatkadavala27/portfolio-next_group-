    ...
    <div class="container-fluid px-4 py-4">
        ...
        <div class="mb-4">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <div>
                    <h2 class="mb-1 fw-bold text-dark">Document Categories</h2>
                ...
                <a href="{{ route('admin.document-category.create') }}" class="btn btn-primary px-4 shadow-sm">
            ...
            <div class="card-body p-0">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0 ps-0" id="searchCategory" placeholder="Search document categories...">
                            </div>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="category-tree p-3">
                    @foreach ($parentCategories as $category)
                        @include('admin.document-category.tree-item', ['category' => $category, 'level' => 0])
                    @endforeach
                </div>
            </div>
        </div>
