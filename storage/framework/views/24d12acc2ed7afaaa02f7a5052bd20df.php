            ...
            <div class="footer-content">
                ...
                <div class="footer-column company-column">
                    <div class="company-info">
                        <div class="logo-container">
                            <img src="<?php echo e(asset('assets/logoF.jpg')); ?>" class="footer-logo" alt="NeXT Solution">
                        </div>
                ...
                <div class="footer-column">
                    <div class="footer-section">
                        ...
                        <ul class="footer-links">
                            <?php if($footerCategories->isEmpty()): ?>
                                <li>No categories available.</li>
                            <?php else: ?>
                                <?php $__currentLoopData = $footerCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="<?php echo e(url('/category/' . $categoryItem->id)); ?>">
                ...
                <div class="footer-column">
                    <div class="footer-section">
                        ...
                        <ul class="footer-links">
                            <?php if($footerBrands->isEmpty()): ?>
                                <li>No brands available.</li>
                            <?php else: ?>
                                <?php $__currentLoopData = $footerBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="<?php echo e(url('/brand/' . $brand->slug)); ?>">
...
</style><?php /**PATH D:\2026 -BK\NEXT SOLUTION\FEBRUARY\28-02-2026\next-solutions new\resources\views/layouts/inc/frontend/footer.blade.php ENDPATH**/ ?>