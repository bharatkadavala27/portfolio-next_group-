...
<nav class="navbar navbar-expand-lg navbar-light bg-white">
    <div class="container-fluid">
        ...
        <a href="/" class="no-hover-effect navbar-brand">
            <img class="navbar-logo" src="<?php echo e(asset('assets/silder/logo.jpg')); ?>" alt="Logo" style="max-height: 80px;">
        </a>
        ...
        <div class="d-none d-lg-flex flex-grow-1 justify-content-center px-3 position-relative">
            <form class="d-flex w-100 position-relative" role="search" id="search-form" action="<?php echo e(route('search')); ?>"
                method="GET">
                <?php echo csrf_field(); ?>
...
</style><?php /**PATH D:\2026 -BK\NEXT SOLUTION\FEBRUARY\28-02-2026\next-solutions new\resources\views/layouts/inc/frontend/navbar.blade.php ENDPATH**/ ?>