            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="<?php echo e(route('admin.filters.create')); ?>">Create Filter</a></li>
                            <li><a href="<?php echo e(route('admin.filters.index')); ?>">View Filter</a></li>
                            <!-- <li><a href="<?php echo e(route('admin.filters.index')); ?>">Filter Sequence</a></li> -->
                        ...
                        <ul class="sidebar-submenu" style="display: none;">
                            ...
                            <li><a class="submenu-title" href="#" data-bs-original-title=""
                                ...
                                <ul class="nav-sub-childmenu submenu-content" style="display: none;">
                                    ...
                                    <li><a href="<?php echo e(url('admin/videos')); ?>">Add YT Video</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list mb-4">
                        ...
                        <ul class="sidebar-submenu mb-4">
                            ...
                            <li>
                                ...
                                <ul class="nav-sub-childmenu submenu-content" style="display: none;">
                                    <li><a href="<?php echo e(route('document-types.create')); ?>">Add Download Type</a></li>
                                    <li><a href="<?php echo e(url('admin/document-types')); ?>">View Download Type</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-sub-childmenu submenu-content" style="display: none;">
                                    <li><a href="<?php echo e(route('admin.document-brands.create')); ?>">Add Download Brand</a></li>
                                    <li><a href="<?php echo e(route('admin.document-brands.index')); ?>">View Download Brand</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-sub-childmenu submenu-content" style="display: none;">
                                    <li><a href="<?php echo e(route('admin.document-category.create')); ?>">Add Download Category</a></li>
                                    <li><a href="<?php echo e(route('admin.document-category.index')); ?>">View Download Category</a></li>
                                </ul>
                            </li>

                            <li><a href="<?php echo e(route('admin.documents-sections.create')); ?>">Add Download</a></li>
                            <li><a href="<?php echo e(route('admin.documents-sections.index')); ?>">View Download</a></li>
...
</div><?php /**PATH D:\2026 -BK\NEXT SOLUTION\FEBRUARY\28-02-2026\next-solutions new\resources\views/layouts/inc/admin/sidebar.blade.php ENDPATH**/ ?>