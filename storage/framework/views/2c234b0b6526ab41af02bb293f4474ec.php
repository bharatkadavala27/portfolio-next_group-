<?php $__env->startSection('title', $fileName ?? ($parentCategory->name ?? 'Documents')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="layout-category-container">
        <nav aria-label="breadcrumb" class="">
            <ol class="breadcrumb product-path">
                ...
                <?php if(isset($parentCategory) && $parentCategory): ?>
                    <li class="breadcrumb-item active"><?php echo e($parentCategory->name); ?></li>
                <?php endif; ?>
            </ol>
        </nav>
        ...
        <div class="category-class mt-5">
            <?php if(isset($parentCategory) && $parentCategory): ?>
                <p><?php echo e($parentCategory->name); ?></p>
                <?php if(!empty($parentCategory->description)): ?>
                    <div class="mt-2 description text-muted fs-6"><?php echo $parentCategory->description; ?></div>
                <?php endif; ?>
        ...
        <div class="container my-5">
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    ...
                    <form id="filters-form" method="GET" action="<?php echo e($actionUrl); ?>">
                        
                        <?php $__currentLoopData = $preserve; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(is_array($v)): ?>
                        ...
                        <?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!isset($filter->isVisible) || !$filter->isVisible) continue; ?>

                            <?php if(isset($filter->key) && $filter->key === 'subcategory_system'): ?>
                                <!-- Subcategories System Filter -->
                                <div class="card mb-3 shadow-sm">
                                    <div class="card-header"><?php echo e($filter->name); ?></div>
                                    <div class="card-body" id="subcategory-list">
                                        <?php $__currentLoopData = $filter->viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="form-check">
                                                    ...
                                                    <input type="checkbox" class="form-check-input subcategory-checkbox"
                                                        ...
                                                        name="subcategories[]" 
                                                        >
                                                    <label class="form-check-label" for="subcategory-<?php echo e($subcategory->id); ?>">
                            ...
                            <?php elseif(isset($filter->key) && $filter->key === 'document_type_system'): ?>
                                <!-- Document Type System Filter -->
                                <div class="card mb-3 shadow-sm">
                                    <div class="card-header"><?php echo e($filter->name); ?></div>
                                    <div class="card-body" id="document-type-list">
                                         <?php $__currentLoopData = $filter->viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input document-type-checkbox" 
                                                    id="type-<?php echo e(Str::slug($type)); ?>"
                                                    name="documenttype[]" 
                                                    value="<?php echo e($type); ?>"
                                                    <?php echo e(in_array($type, $selectedTypes ?? []) ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="type-<?php echo e(Str::slug($type)); ?>">
                                                    <?php echo e($type); ?>
                            ...
                            <?php elseif(isset($filter->key) && $filter->key === 'brand_system'): ?>
                                <!-- Brand System Filter -->
                                <div class="card mb-3 shadow-sm">
                                    <div class="card-header"><?php echo e($filter->name); ?></div>
                                    <div class="card-body" id="document-brand-list">
                                        <?php $__currentLoopData = $filter->viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input document-brand-checkbox" 
                                                    id="brand-<?php echo e(Str::slug($brand)); ?>"
                                                    name="documentbrand[]" 
                                                    value="<?php echo e($brand); ?>"
                                                    <?php echo e(in_array($brand, $selectedBrands ?? []) ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="brand-<?php echo e(Str::slug($brand)); ?>">
                                                    <?php echo e($brand); ?>
                            ...
                            <?php else: ?>
                                ...
                                <div class="card mb-3 shadow-sm">
                                    <div class="card-header"><?php echo e($filter->name); ?></div>
                                    <div class="card-body">
                                        <?php $__currentLoopData = $filter->viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input filter-checkbox"
                                                    id="option-<?php echo e($option->id); ?>" name="filter_options[]"
                                                    value="<?php echo e($option->id); ?>" 
                                                    <?php echo e((isset($selectedOptions) && in_array($option->id, $selectedOptions)) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-12 mb-3">
                            <div class="card document-card shadow-sm">
                                <div class="card-header">
                                    <h5 class="document-title"><?php echo e($doc->document_name); ?></h5>
                                    <?php if(!empty($doc->description)): ?>
                                        <div class="doc-description text-muted mt-1"><?php echo $doc->description; ?></div>
                                    <?php endif; ?>
                                </div>
                                <div class="card-body">
                                    <div class="main-info mb-2">
                                        <span class="doc-type"><?php echo e($doc->document_type ?? 'Document'); ?> (<?php echo e($doc->size ??
                    'N/A'); ?>)</span>
                                        <span class="mx-2">|</span>
                                        <span class="version-date"><?php echo e($doc->version_date ?
                    \Carbon\Carbon::parse($doc->version_date)->format('d M Y') : 'N/A'); ?></span>
                                        <span class="mx-2">|</span>
                                        <span class="brand-name"><?php echo e($doc->document_brand ?? 'Unknown'); ?></span>
                                    </div>
                                    <div class="sub-info text-muted">
                                        Language: <?php echo e($doc->language ?? 'English'); ?>

                                        <span class="mx-2">|</span>
                                        Latest Version: <?php echo e($doc->version ?? '1.0'); ?>

                                    </div>
                                    <?php if(!empty($doc->description)): ?>
                                        <div class="doc-description text-muted"><?php echo $doc->description; ?></div>
                                    <?php endif; ?>
                                </div>
                                <div class="card-footer">
                                    <a href="<?php echo e(asset($doc->file_path)); ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                            ...
                            <?php $__currentLoopData = $filter->viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check mb-3">
                                    <input type="checkbox" class="form-check-input subcategory-checkbox filter-checkbox"
                                        value="<?php echo e($subcategory->name); ?>" data-category-id="<?php echo e($subcategory->id); ?>"
                                        id="mobile-subcategory-<?php echo e($subcategory->id); ?>">
                                    <label class="form-check-label filter-label" for="mobile-subcategory-<?php echo e($subcategory->id); ?>">
                                        <?php echo e($subcategory->name); ?>
                            ...
                            <?php $__currentLoopData = $filter->viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check mb-3">
                                    <input type="checkbox" class="form-check-input document-type-checkbox filter-checkbox" 
                                        value="<?php echo e($type); ?>"
                                        id="mobile-type-<?php echo e(Str::slug($type)); ?>"
                                        <?php echo e(in_array($type, $selectedTypes ?? []) ? 'checked' : ''); ?>>
                                    <label class="form-check-label filter-label" for="mobile-type-<?php echo e(Str::slug($type)); ?>">
                                        <?php echo e($type); ?>
                            ...
                            <?php $__currentLoopData = $filter->viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check mb-3">
                                    <input type="checkbox" class="form-check-input document-brand-checkbox filter-checkbox" 
                                        value="<?php echo e($brand); ?>"
                                        id="mobile-brand-<?php echo e(Str::slug($brand)); ?>"
                                        <?php echo e(in_array($brand, $selectedBrands ?? []) ? 'checked' : ''); ?>>
                                    <label class="form-check-label filter-label" for="mobile-brand-<?php echo e(Str::slug($brand)); ?>">
                                        <?php echo e($brand); ?>
                    ...
                    <div class="card mb-0">
                        ...
                        <div class="card-body">
                            <?php $__currentLoopData = $filter->viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check mb-3">
                                    <input type="checkbox" class="form-check-input filter-checkbox"
                                        id="mobile-option-<?php echo e($option->id); ?>" name="filter_options[]"
                                        value="<?php echo e($option->id); ?>" <?php echo e((isset($selectedOptions) &&
                                        in_array($option->id, $selectedOptions)) ? 'checked' : ''); ?>>
                                    <label class="form-check-label filter-label" for="mobile-option-<?php echo e($option->id); ?>">
                                        <?php echo e($option->name); ?>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            const parentCategoryId = <?php if(isset($parentCategory) && $parentCategory): ?> '<?php echo e($parentCategory->id); ?>' <?php else: ?> null <?php endif; ?>;
